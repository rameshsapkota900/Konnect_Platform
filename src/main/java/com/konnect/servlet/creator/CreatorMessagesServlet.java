...
/**
 * CreatorMessagesServlet
 * Handles messaging for creators
 */
@WebServlet("/creator/messages")
public class CreatorMessagesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        request.getRequestDispatcher("/creator/messages.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (messageId > 0) {
            ...
            response.sendRedirect(request.getContextPath() + "/creator/messages?userId=" + receiverId);
        } else {
            // Set error message
