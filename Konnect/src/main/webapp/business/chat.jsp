        ...
        <ul class="chat-partner-list">
            ...
            <% } else { %>
                <% for (User partner : chatPartners) { %>
                    <li>
                        <a href="<%= request.getContextPath() %>/business/chat?with=<%= partner.getUserId() %>"
    ...
    <div class="chat-main">
        <% if (currentPartner != null) { %>
            ...
            <div class="chat-input">
                <form action="<%= request.getContextPath() %>/business/chat" method="POST" style="display: flex; width: 100%;">
        ...
        <% } else { %>
            ...
            <div class="chat-messages no-chat-selected">
                ...
                <p>Select a creator from the list on the left to start chatting.</p>
            </div>
            <div class="chat-input">
